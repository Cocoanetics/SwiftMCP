...
private struct RFC6570TemplateExtractor {
    ...
    private func extractAllVariablesFromExpression(
        ...
        case .reserved:
            return extractAllReservedVariables(variables: variableSpecs, fromURL: url, startingAt: startIndex)
        case .label:
    ...
    private func extractAllPathStyleVariables(
        ...
        for variable in variables {
            ...
            var paramName = ""
            while paramIndex < url.endIndex && url[paramIndex] != "=" && url[paramIndex] != ";" && url[paramIndex] != "?" && url[paramIndex] != "#" {
