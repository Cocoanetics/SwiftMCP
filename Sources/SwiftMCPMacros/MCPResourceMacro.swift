...
public struct MCPResourceMacro: PeerMacro {
    public static func expansion(
        ...
        for param in parameterInfos {
            ...
            let paramType = param.type.replacingOccurrences(of: "?", with: "") // Use non-optional type for extraction

            // Parameters are expected to be of the correct type after enrichArguments
            // and extractValue will handle the casting.
            wrapperMethod += """
