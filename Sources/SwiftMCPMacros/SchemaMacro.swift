...
public struct SchemaMacro: MemberMacro, ExtensionMacro {
    public static func expansion(
        ...
        ///
        /// autogenerated
        static let __schemaMetadata = SchemaMetadata(
            name: "\(structName)",
        ...
        public static var schema: JSONSchema {
            __schemaMetadata.schema
        }
        """
        
        return [
            DeclSyntax(stringLiteral: registrationDecl),
            DeclSyntax(stringLiteral: schemaDecl)
        ]
    }
    ...
    private static func processProperty(
        ...
        let enumValuesStr = ".init(caseLabelsFrom: \(propertyType).self)"
